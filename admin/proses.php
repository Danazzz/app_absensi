...
if(isset($_POST['add'])) {
    ...
    mysqli_query($con,"INSERT INTO tb_absensi (id_user, tgl, s_in, ket) VALUES ('$id_user', '$tgl', '$s_in', '$ket')") or die (mysqli_error($con));
    ...
    mysqli_query($con,"UPDATE tb_absensi SET tgl = '$tgl', s_in = '$s_in', ket = '$ket' WHERE id_user = '$id' )") or die (mysqli_error($con));
    echo "<script>alert('Anda telah absen');window.location='data.php';</script>";
}
?>