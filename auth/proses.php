...
if(isset($_POST['add'])) {
    ...
    mysqli_query($con,"INSERT INTO tb_mahasiswa(id_mahasiswa, id_user, nama, jkel, alamat, no_telp, instansi) VALUES ('', '$identitas', '$nama', '$jkel', '$alamat', '$no_telp', '$instansi')") or die (mysqli_error($con));
